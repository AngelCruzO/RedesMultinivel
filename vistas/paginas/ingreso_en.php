			...
			<figure class="p-2 p-sm-5 p-lg-4 p-xl-5 text-center">
				...
				<a href="<?php echo $ruta; ?>inicio"><img src="img/logo-positivo.png" class="img-fluid"></a>
						...
						<div class="dropdown text-right">
							...
							<button type="button" class="btn btn-light btn-sm dropdown-toggle border" data-toggle="dropdown">
								<form action="<?php echo "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>" method="post">
									...
									<input type="submit" value="EN" style="border: 0;background: transparent;padding: 0;margin: 0;float: left;cursor: pointer;">
								</form>
							</button>
					...
					<form class="mt-5" method="post" >
						...
						<p class="text-center pt-1">Do not you have an account yet? | <a href="<?php echo $ruta; ?>registro">Sign up</a></p>

						<p class="text-center pt-1">Forgot your password?</p>
