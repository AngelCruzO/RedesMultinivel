						...
						<div class="dropdown">
							...
							<button type="button" class="btn btn-light btn-sm dropdown-toggle pr-3" data-toggle="dropdown">
								<form action="<?php echo $ruta; ?>" method="post">
									...
									<input type="submit" translate="no" value="EN" style="border: 0;background: transparent;padding: 0;margin: 0;float: left;cursor: pointer;">
								</form>
							</button>
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item">
									...
									<form action="<?php echo $ruta; ?>" method="post">
										...
										<input type="submit" translate="no" value="ES" style="border: 0;background: transparent;padding: 0;margin: 0;cursor: pointer;">
									</form>
